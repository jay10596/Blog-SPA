        ...
        <div class="bg-blue-900 w-96 rounded-lg shadow-xl p-6">
            ...
            <form class="mt-8" @submit.prevent="login">
                ...
                <div class="reletive">
                    ...
                    <div class="col-md-6">
                        <input v-model="loginForm.email" class="pt-8 w-full rounded bg-blue-800 p-1 text-gray-100 outline-none focus:bg-blue-700" type="text" placeholder="Enter your Email">
                ...
                <div class="pt-3">
                    ...
                    <div class="">
                        <input v-model="loginForm.password" class="pt-8 w-full rounded bg-blue-800 p-1 text-gray-100 outline-none focus:bg-blue-700" type="text" placeholder="Enter your password">
