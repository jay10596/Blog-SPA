<template>
    <div class="w-full h-screen flex justify-center items-center bg-fixed">
        <div class="bg-transparent opacity-100 w-4/6 rounded-lg shadow-2xl border border-red-900 p-6">

            <form class="mt-8" @submit.prevent="editQuestion">
                ...
                <div class="">
                    ...
                    <button @click="editCancel" class="mt-8 uppercase rounded-lg shadow-2xl border border-red-900 bg-transparent text-gray-100 hover:bg-gray-100 hover:text-red-900 font-semibold w-full h-8 px-2 text-left">
                        Cancel
                    </button>
                </div>
            </form>
